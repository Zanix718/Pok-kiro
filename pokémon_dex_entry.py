POKEMON_DEX_NUMBERS = {
    ...
    "farfetch'd": 83, "doduo": 84, "dodrio": 85,
    "seel": 86, "dewgong": 87,
    "grimer": 88, "muk": 89,
    ...
    "tinkatink": 957, "tinkaton": 958, "tinkaton": 959,
...
def get_pokemon_dex_number(pokemon_name):
    if not pokemon_name:
        return 1
    normalized_name = pokemon_name.lower().strip()
    dex_number = POKEMON_DEX_NUMBERS.get(normalized_name)
    if dex_number:
        return dex_number
    return 1
def get_pokemon_artwork_url(pokemon_name):
    dex_number = get_pokemon_dex_number(pokemon_name)
